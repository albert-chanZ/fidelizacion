...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2025 a las 09:55:10
...
CREATE TABLE `clientes` (
  ...
  `voice_print_id` varchar(255) DEFAULT NULL,
  `voz_frase_secreta` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `clientes` (`telefono`, `nombre`, `apellidos`, `direccion`, `correo`, `estado`, `ciudad`, `puntos`, `password`, `voice_print_id`, `voz_frase_secreta`) VALUES
('1234567890', 'Carlos ', 'Chuc', 'Calle desconocida', 'carlos@gmail.com', 'Yucatán', 'Tekax', 5, '$2y$10$stUUNIjgc5ZaGUVvv1mF4umxU7nhcY3MddXrXY5D6KsrnHgUtw7yW', NULL, 'hola'),
('9992000107', 'Manuel', 'Ek', 'desconocido', 'manuel@gmail.com', 'Yucatán', 'Tekax', 4495, '$2y$10$dPZHSqafM56TCqy2mEqNBuAIPRpX8P/ZKJvtp3om.SiwyKKb1lrP2', NULL, 'mi nombre es manuel'),
('admin', 'Carlos', 'admin', 'calle 43 x 66 y 68', 'ichan.zib@gmail.com', 'Yucatán', 'Tekax', 0, '$2y$10$LF6GUL4/B5thplk2PU99LOtfl3ilcqVRcFBQO8gv6tg9MKXZbuxvO', NULL, 'hola\n');
...
ALTER TABLE `clientes`
  ...
  ADD UNIQUE KEY `voice_print_id` (`voice_print_id`);
